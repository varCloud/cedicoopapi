...
function InitDataTable() {
    ...
    $('#tblSocios_filter input').addClass('form-control');
    $('#tblSocios_filter').append('&nbsp;&nbsp;<button value=""  title="Agregar" data-toggle="tooltip"  class="tooltip-wrapper btn btn-icon btn-round btn-outline-dark" name="" id="btnAgregarSocio"><i class="fa fa-plus"></i></button>');
    InitBtnAgregar();
}
